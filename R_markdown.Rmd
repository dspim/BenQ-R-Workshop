...
<div style='float:right; margin: 200px;'>
  <img src='img/one1.jpg' style='height: 250px'></img>
</div>
...
## Overview
<center>
`r fig("RmdOverview.png", 77)` 
</center>

## Markdown
<center>
`r fig("markdownOverview.png",200)`  
</center>

## R Code Chunks
<center>
`r fig("markdownChunk.png", 70)`  
</center>
...
```{r plot1,fig.width=8, fig.height=3}
plot(women)  
```  
...
## Exercise: Original：  
`r fig("forecast_tpe1.png")`  

## Exercise: After：
`r fig("exam_q1.png", 60)`  
...
<div style="float: left; width: 50%;">
  `r fig("shiny-cars-table.gif", 90)`
</div>

<div style="float: right; width: 50%;">
  `r fig("shiny-hist-plot.gif", 90)` 
</div>
